...
<body>
   ...
   <section class="header"> 
    ...
    <ul>
        <a href="ban_member.php" class="btnstyle">Bannir un membre</a>
        <a href="adminpanier.php" class="btnstyle">Ajouter ou supprimer un produit</a>
    </ul>
            <div>
        ...
        <div class="nav">
            <div class="links">
                ...
                <a href="adminpanier.php">Produits</a>
